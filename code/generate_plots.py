...
def make_baseline_kinetics() -> PSLTKinetics:
    ...
    chi_prof = select_chi_profile(Path(__file__).resolve().parent.parent, d_scan)
    superrad_prof = select_superrad_profile(Path(__file__).resolve().parent.parent, d_scan)
