...
def _plot_slices(slices: pd.DataFrame, out_path: Path) -> None:
    ...
    for mode_key in ["fullwidthrefamp_pointamp_widthboost", "fullwidthrefamp_pointamp2_widthboost"]:
...
def main() -> None:
    ...
    detail_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp2_widthboost_hotspot_smoke_detail.csv"
    summary_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp2_widthboost_hotspot_smoke_summary.csv"
    slices_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp2_widthboost_hotspot_smoke_slices.csv"
    png_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp2_widthboost_hotspot_smoke.png"
    meta_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp2_widthboost_hotspot_smoke_run_meta.json"
