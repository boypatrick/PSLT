...
MODES = [
    ...
    (
        ...
        "fullwidthrefamp_pointamp2_widthboost_base",
    ),
    (
        "cell_direct_runtime_release_fullwidthrefamp_pointamp3_widthboost",
        "fullwidthrefamp_pointamp3_widthboost_candidate",
    ),
]
...
def _plot_slices(slices: pd.DataFrame, out_path: Path) -> None:
    palette = {
        "fullwidthrefamp_pointamp2_widthboost_base": "#f28e2b",
        "fullwidthrefamp_pointamp3_widthboost_candidate": "#76b7b2",
    }
...
def main() -> None:
    ...
    detail_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp3_widthboost_hotspot_smoke_detail.csv"
    summary_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp3_widthboost_hotspot_smoke_summary.csv"
    slices_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp3_widthboost_hotspot_smoke_slices.csv"
    png_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp3_widthboost_hotspot_smoke.png"
    meta_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp3_widthboost_hotspot_smoke_run_meta.json"
