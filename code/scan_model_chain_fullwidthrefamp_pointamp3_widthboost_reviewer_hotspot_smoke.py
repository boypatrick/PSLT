...
MODES = [
    ...
    ('cell_direct_runtime_release_fullwidthrefamp_pointamp3_widthboost', 'pointamp3_mode'),
]
...
def _plot(slices: pd.DataFrame, out_path: Path) -> None:
    palette = {'base_mode': '#f28e2b', 'pointamp3_mode': '#59a14f'}
    fig, axes = plt.subplots(1, 2, figsize=(10.8, 4.2), constrained_layout=True, sharex=True)
    for mode_key in ['base_mode', 'pointamp3_mode']:
...
def main() -> None:
    ...
    detail_path = OUTDIR / 'model_chain_fullwidthrefamp_pointamp3_widthboost_reviewer_hotspot_smoke_detail.csv'
    summary_path = OUTDIR / 'model_chain_fullwidthrefamp_pointamp3_widthboost_reviewer_hotspot_smoke_summary.csv'
    slices_path = OUTDIR / 'model_chain_fullwidthrefamp_pointamp3_widthboost_reviewer_hotspot_smoke_slices.csv'
    png_path = OUTDIR / 'model_chain_fullwidthrefamp_pointamp3_widthboost_reviewer_hotspot_smoke.png'
    meta_path = OUTDIR / 'model_chain_fullwidthrefamp_pointamp3_widthboost_reviewer_hotspot_smoke_run_meta.json'
