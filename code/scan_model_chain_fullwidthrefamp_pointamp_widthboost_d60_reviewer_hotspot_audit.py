...
def main() -> None:
    ...
    summary_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp_widthboost_d60_reviewer_hotspot_audit_summary.csv"
    slices_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp_widthboost_d60_reviewer_hotspot_audit_slices.csv"
    png_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp_widthboost_d60_reviewer_hotspot_audit.png"
    meta_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp_widthboost_d60_reviewer_hotspot_audit_run_meta.json"
