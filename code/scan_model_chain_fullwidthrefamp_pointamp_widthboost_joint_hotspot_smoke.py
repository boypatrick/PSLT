...
MODES = [
    ...
    (
        ...
        "fullwidthrefamp_pointamp_widthboost_joint",
    ),
]
...
def _plot_slices(slices: pd.DataFrame, out_path: Path) -> None:
    palette = {
        ...
        "fullwidthrefamp_pointamp_widthboost_joint": "#e15759",
    }
    fig, axes = plt.subplots(1, 2, figsize=(10.8, 4.2), constrained_layout=True, sharex=True)
    for mode_key in ["fullwidthrefamp_pointamp_widthboost", "fullwidthrefamp_pointamp_widthboost_joint"]:
...
def main() -> None:
    ...
    detail_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp_widthboost_joint_hotspot_smoke_detail.csv"
    summary_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp_widthboost_joint_hotspot_smoke_summary.csv"
    slices_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp_widthboost_joint_hotspot_smoke_slices.csv"
    png_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp_widthboost_joint_hotspot_smoke.png"
    meta_path = OUTDIR / "model_chain_fullwidthrefamp_pointamp_widthboost_joint_hotspot_smoke_run_meta.json"
