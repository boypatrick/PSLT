...
STEM = "observable_two_lobe_d8_maplate_currentbase_runtime_validation"

CHAIN_MODE = "cell_direct_runtime_release_fullwidthrefamp_pointamp2_widthboost_twolobe_d8maplate"
BASE_CHAIN_MODE = "cell_direct_runtime_release_fullwidthrefamp_pointamp2_widthboost"
TAG_SUFFIX = "20260329_refsnapfix_d8maplate_r3"
RUNTIME_SUFFIX = "20260329_refsnapfix"
...
CASE_CONFIG = {
    "D60_hotspot": {
        ...
        "runtime_map": MAP_DIR / f"hll_signal_strength_map_chain_mode_cell_direct_runtime_release_fullwidthrefamp_pointamp2_widthboost_twolobe_D60E21_runtime_{RUNTIME_SUFFIX}.csv",
    },
    "D21_guard": {
        ...
        "runtime_map": MAP_DIR / f"hll_signal_strength_map_chain_mode_cell_direct_runtime_release_fullwidthrefamp_pointamp2_widthboost_twolobe_D21E41_runtime_{RUNTIME_SUFFIX}.csv",
    },
}
        ...
        json.dumps(
            {
                ...
                "notes": (
                    "Validation of the map-layer experimental runtime two-lobe + D8 tail mode against current freshly generated mainline base maps and the corrected raw two-lobe runtime mode. "
                    "This checks the best late mu-linear blend from the D≈8.0 tail-guard shortlist on the current snapped-ref code path."
                ),
            },
            indent=2,
        )
