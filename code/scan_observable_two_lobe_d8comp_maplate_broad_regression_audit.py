...
STEM = "observable_two_lobe_d8comp_maplate_broad_regression_audit"
...
CASE_CONFIG = {
    "D60E21_fullmap": {
        ...
        "candidate_map": MAP_DIR / "hll_signal_strength_map_chain_mode_cell_direct_runtime_release_fullwidthrefamp_pointamp2_widthboost_twolobe_d8compmaplate_D60E21_runtime_20260330_refsnapfix_d8comp_r1.csv",
    },
    "D21E41_fullmap": {
        ...
        "candidate_map": MAP_DIR / "hll_signal_strength_map_chain_mode_cell_direct_runtime_release_fullwidthrefamp_pointamp2_widthboost_twolobe_d8compmaplate_D21E41_runtime_20260330_refsnapfix_d8comp_r1.csv",
    },
}
...
def _plot(slices: pd.DataFrame, out_png: Path) -> None:
    ...
    for ax, (case_name, grp) in zip(axes, slices.groupby("case", sort=False)):
        ...
        ax.plot(grp["D"], grp["slice_p95_abs_delta_parent"], marker="o", color=palette["parent"], label="d8maplate")
...
def main() -> None:
    ...
    meta_path.write_text(json.dumps({
        ...
        "notes": "Broad full-map regression check for twolobe_d8compmaplate against current mainline base and twolobe_d8maplate parent, including reviewer-target and non-reviewer complement subsets.",
    }, indent=2))
