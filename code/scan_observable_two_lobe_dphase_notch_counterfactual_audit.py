...
STEM = "observable_two_lobe_dphase_notch_counterfactual_audit"
...
BOOST_GRID = (0.2, 0.4, 0.6, 0.8)
BOOST_CENTER_GRID = (6.35, 6.40, 6.45)
BOOST_WIDTH_GRID = (0.03, 0.05, 0.07)
        ...
        json.dumps(
            {
                ...
                "combos": combos,
                "notes": (
                    "Two-lobe runtime-compatible observable D-phase notch shortlist on the current reviewer mainline. "
                    "A suppressive Lorentz-descended D-phase notch is paired with a narrow compensating positive lobe near D~6.4 "
                    "to test whether D60 suppression can coexist with D21 guard preservation."
                ),
            },
            indent=2,
        )
