...
OUT_SCAN = OUTDIR / "runtime_direct_detlin_joint_tailgnorm_audit_scan.csv"
OUT_SUMMARY = OUTDIR / "runtime_direct_detlin_joint_tailgnorm_audit_summary.csv"
OUT_SLICES = OUTDIR / "runtime_direct_detlin_joint_tailgnorm_audit_best_slices.csv"
OUT_ACTIVATION = OUTDIR / "runtime_direct_detlin_joint_tailgnorm_audit_best_activation.csv"
OUT_PNG = OUTDIR / "runtime_direct_detlin_joint_tailgnorm_audit.png"
OUT_META = OUTDIR / "runtime_direct_detlin_joint_tailgnorm_audit_run_meta.json"
...
BETA_VALUES = [0.02, 0.04, 0.06, 0.08, 0.10, 0.12]
...
def main() -> None:
    ...
    fig.suptitle("strict all-direct joint tailm2 + narrow gnorm audit")
