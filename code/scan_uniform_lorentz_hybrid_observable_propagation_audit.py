...
STEM = "uniform_lorentz_hybrid_observable_propagation_audit"
        ...
        json.dumps(
            {
                ...
                "notes": (
                    "Observable-side audit for the Lorentz hybrid family. Only chi_LR and the g3_raw/higher raw-g tower "
                    "are substituted using the length_contraction beta=0.4 extraction candidate; Gamma_ref and width remain uniform."
                ),
            },
            indent=2,
        )
