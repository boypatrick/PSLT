...
from scan_uniform_lorentz_hybrid_chain_propagation_audit import (
    N_MAX,
    OBSERVABLE_MODE,
    T_COH,
...
STEM = "uniform_lorentz_hybrid_reviewer_counterfactual_audit"
...
def main() -> None:
    ...
    hybrid_kin = kinetics["lorentz_hybrid_profile"]
        ...
        json.dumps(
            {
                ...
                "notes": (
                    "Counterfactual reviewer audit for the uniform Lorentz hybrid family. The current mainline map is kept "
                    "unchanged; only the Lorentz-hybrid chi/g observable effect is injected when recomputing mu_mumu."
                ),
            },
            indent=2,
        )
