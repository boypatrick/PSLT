...
\label{eq:mu_pred}
\end{equation}
Here $(D_0,\eta_0)=(10,1)$ is a fixed reference point. Equation~\eqref{eq:mu_pred} is implemented in \texttt{pslt\_lib.py} with \texttt{hll\_observable\_mode=eft\_wilson\_matched}; it is still a scan-level EFT module (not yet a full UV-to-EFT derivation from loop-level EYMH matching).
\begin{equation}
