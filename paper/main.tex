...
\begin{enumerate}
    ...
    \item \textbf{Model-chain unification}: $\chi_N^{(LR)}(D)$ and $\tilde A_\ell(D)$ are injected from action-derived full-grid profiles in the global $(D,\eta)$ map. A full end-to-end scan with direct localized recomputation at every grid point and channel remains future work.
