...
$\Gamma_{N,\ell}$ channel normalization ($A_\ell$) & Action-derived profile baseline $\tilde A_\ell(D)$ with constant-$A_\ell$ legacy comparator & Yes & Extend to fully localized channel-resolved extraction over $(D,\eta,N)$ \\
