...
This extension remains a map-level proxy exercise: it does not yet replace the visibility sector with explicit overlap-defined $y_N^{\rm eff}$ operators in the global scan. A full three-channel 2D overlap program is reserved for future work.
