...
- `evaluate_v2_parametric_d.py`: V2.3 dense-\(D\) evaluator for a saved
  V2.2 model, with suspicious-cell finite-volume follow-up policy.
...
- `v2_dense_midpoint_summary.csv`: V2.3 dense midpoint diagnostic for
